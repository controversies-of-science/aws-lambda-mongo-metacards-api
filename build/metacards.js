...
let MongoClient = __webpack_require__(2).MongoClient;
...
module.exports.list = (event, context, callback) => {
    MongoClient.connect(process.env.MLABDB, (err, db) => {
        ...
        db.collection(METACARDS).find().toArray((err, docs) => {
            ...
            if (error) {
                ...
                const response = {
                    ...
                    body: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()({
                        message: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(docs),
                        input: event
                    })
                };
